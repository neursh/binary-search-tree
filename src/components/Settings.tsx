...
export default function Settings() {
  ...
  return (
    <section className="fixed top-0 right-0">
      ...
      >
        <div
          className="w-8 h-8 rounded-full outline outline-2 outline-slate-300 flex items-center justify-center cursor-pointer"
        ...
        <motion.div
          className="relative w-96 h-48 m-2 p-2 rounded-lg outline outline-2 outline-slate-300 bg-white flex flex-col"
          initial={{ height: 192 }}
